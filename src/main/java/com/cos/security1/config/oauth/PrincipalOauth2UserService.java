...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		// 구글로그인 버튼 클릭 -> 구글로그인 창 -> 로그인을 완료 -> 코드를 리턴 (OAuth -> Client 라이브러리) ->
		// AccessToken 요청
		...
		String username = provider+"_"+providerId; // google_123492034701
		String password = new BCryptPasswordEncoder().encode("donghoon");
		...
		if (userEntity == null) {
			...
			System.out.println("로그인을 이미 한 적이 있습니다. 자동 회원가입이 되어 있습니다.");
		}
